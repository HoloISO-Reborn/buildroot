...
export POSTREMOVE_PACKAGES="a52dec vlc vulkan-mesa-layers lib32-vulkan-mesa-layers libliftoff libva-utils cups print-manager bluez-plugins go kdegraphics-mobipocket kdegraphics-thumbnailers openvr jsoncpp python-autocommand python-build python-installer python-jaraco.context python-jaraco.functools python-jaraco.text python-more-itertools python-packaging python-platformdirs python-pyproject-hooks python-setuptools python-wheel"
